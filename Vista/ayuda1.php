            ...
            <main>
                ...
                <div class="row justify-content-center align-items-center" style="min-height: 76vh;">
                    ...
                    <div class="col-md-7 bg-light p-5 rounded">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item active" aria-current="true"><a href="?p=1">1. ¿Cómo registrarse en HELPER'S?</a></li>
                        ...
                        <div class="container cuerpoAyuda">
                            <div class="col-12 rounded pt-4 pb-1">
                                <h4 class="text-center"><b><u>Registro de usuarios</u></b></h4><br>
                                <p>El uso de la aplicación requiere registro en la plataforma para acceder al sistema de gestión de incidencias. 
                                    <br><br>Para ello, en la página de Credenciales, pulsaremos el botón “Regístrate”<br><br>
                                    <img src="../Vista/img/ayuda/captura1.png" class="img-fluid" alt="..."><br><br>
                                    Aparecerá un formulario para cumplimentar, en el cuál debemos de rellenar con la información solicitada en cada campo. Es importante recordar que cada Dni está ligado a un email para un único usuario. <br>
                                    Una vez se completen todos los campos, deberemos dar click en el botón “Enviar” para que el registro se complete.<br><br>
                                    <img src="../Vista/img/ayuda/captura2.png" class="img-fluid" alt="..."><br><br>
                                    Si todo ha ido bien, veremos el siguiente mensaje:<br><br>
                                    <img src="../Vista/img/ayuda/captura3.png" class="img-fluid" alt="..."><br><br>
                                </p>
                            </div>
                        </div>
                    </div>
