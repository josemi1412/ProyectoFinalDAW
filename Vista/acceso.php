...
<html lang="es">
  ...
  <body>
            ...
            <main>
                <div class="container mt-3 mb-3" style="margin-top: 0;">
                <div class="row justify-content-center align-items-center" style="min-height: 76vh;">

                    <div class="col-md-7 bg-light p-5 rounded">

                        <h2 class="text-center bg-primary text-light text-uppercase py-2">CREDENCIALES</h2>

                        <form action="" method="post">
                            <div class="mb-3">
                            <label for="dni" class="form-label">Usuario: </label>
                            <input type="text" id="dni" name="dni" class="form-control <?php if (isset($dni_error)): ?> is-invalid <?php endif ?>" required placeholder="Introduzca aqui su DNI">
                            ...
                            <input type="password" id="password" name="password" class="form-control <?php if (isset($pass_error)): ?> is-invalid <?php endif ?>" required placeholder="Introduzca aquí su contraseña">
                            ...
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" onclick="window.location.href='registrarse.php'">Regístrate</button>
                        </form>
