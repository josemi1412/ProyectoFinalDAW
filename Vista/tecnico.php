                    ...
                    <div class="col-md-12 bg-light p-5">
                        ...
                        <div class="row mt-3">
                            <div class="col d-flex flex-lg-row flex-column justify-content-center">
                                <button type="button" class="btn btn-primary mb-1 mb-lg-0" onclick="window.location.href='../Controlador/verIncidenciasRegistradas.php'">Ver incidencias registradas</button>
                                <button type="button" class="btn btn-primary ms-lg-1 mb-1 mb-lg-0" onclick="window.location.href='../Controlador/verIncidenciasTecnico.php'">Ver incidencias atendidas</button>
