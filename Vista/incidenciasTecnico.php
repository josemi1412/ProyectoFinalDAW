                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($incidencia->getEstado()!=2): ?>
                                                ...
                                                <form action="../Controlador/cambiarEstadoIncidencia.php" method="post" id="myForm2">
                                                    ...
                                                    ?>
                                                    <input type="submit" class="btn btn-modificar" value="Cambiar estado">
                                                </form>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($incidencia->getEstado()!=2): ?>
                                                ...
                                                <form action="../Controlador/abandonarIncidencia.php" method="post" id="myForm2">
                                                    <input type="hidden" name="incidenciaId" value="<?=$incidencia->getId()?>">
