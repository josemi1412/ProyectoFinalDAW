                        ...
                        <form action="" method="post">
                            <div class="mb-3">
                                ...
                                <?php if (isset($data['tipoNombre'])): ?>
                                    <input type="text" id="nombre" name="nombre" class="form-control" required placeholder="Escribe el nombre" value="<?=$data['tipoNombre']?>">
                                <?php else: ?>
                            ...
                            <div class="mb-3">
                                ...
                                <?php if (isset($data['tipoDescripcion'])): ?>
                                    <textarea class="form-control" id="descripcion" name="descripcion" rows="3" required placeholder="Escribe una descripción"><?=$data['tipoDescripcion']?></textarea>
                                <?php else: ?>
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" onclick="window.location.href='../Controlador/gestionarTipos.php'">Volver</button>
                ...
                <div class="modal-dialog modal-dialog-centered modal-confirm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <button class="btn btn-success" data-dismiss="modal" onclick="window.location.href='../Controlador/gestionarTipos.php'"><span>Continuar</span> <i class="material-icons">&#xE5C8;</i></button>
                        </div>
                    </div>
                </div>
            </div>
