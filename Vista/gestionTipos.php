            ...
            <main>
                ...
                <div class="row justify-content-center align-items-center" style="min-height: 76vh;">
                        ...
                        <div class="col-12 bg-light p-5 rounded">
                            ...
                            <h2 class="text-center bg-primary text-light text-uppercase py-2">Gestión de áreas de trabajo</h2>
                            ...
                            <form action="" method="post">
                                    ...
                                    <div class="col d-flex flex-row align-items-center">
                                        ...
                                        <input type="text" id="nombreTipo" name="nombreTipo" class="form-control" required placeholder="Escribe el nombre">
                                        </div>
                                        ...
                                        <?php if(!$tipo->getEstaEliminado()): ?>
                                            <tr>
                                                    ...
                                                    <form action="" method="post">
                                                        ...
                                                        <?php
                                                            if (isset($_POST['nombreTipo'])) {
                                                                echo '<input type="hidden" name="nombreTipo" value="'.$_POST["nombreTipo"].'">';
                                                            }
                                                        ?>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="../Controlador/modificarTipo.php" method="post">
                            ...
                            <div class="row">
                                <div class="col">
                                     <button type="button" class="btn btn-success" data-bs-toggle="modal" onclick="window.location.href='../Controlador/nuevoTipo.php'">Añadir</button>
            ...
            <div class="modal fade" id="myModal2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="revisionIncidenciaLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form action="../Controlador/eliminarTipo.php" method="post">
